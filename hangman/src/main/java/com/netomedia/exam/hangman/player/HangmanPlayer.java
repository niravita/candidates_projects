...
public class HangmanPlayer {
	...
	public static final String LETTERS_FILE_NAME = "letters.txt";
...
//			System.out.println("Your guess is: " + guess);
	...
	public Integer play(String word) throws Exception {

		ServerResponse serverResponse = server.startNewGame(word);
		int wordLength = serverResponse.getHangman().length();
...
//			System.out.println("Your guess is: " + guess);
			...
			if (serverResponse.getGameEnded()) {
				failedAttempts = serverResponse.getFailedAttempts();
			}
			filterWordsFromDict(serverResponse, guess);
	...
	public static Letter getMostFrequentLetter() {
		...
		letters.sort(Comparator.comparing(Letter::getWordsContainTheLetter)
				.thenComparing(Letter::getOccurancesInDictionary));
